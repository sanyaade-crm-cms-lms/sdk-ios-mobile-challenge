//
//  RetailBankingAccountBalance+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingAccountBalance+Remote.h"

@implementation RetailBankingAccountBalance (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"type" forKey:@"balance_type"];
        [fieldMappings setObject:@"value" forKey:@"value"];
        ...
        config.httpVerb = @"GET";
        config.incrementalPath = @"/accounts/{{params.id}}/balances";
