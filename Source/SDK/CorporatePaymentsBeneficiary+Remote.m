//
//  CorporatePaymentsBeneficiary+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "CorporatePaymentsBeneficiary+Remote.h"

@implementation CorporatePaymentsBeneficiary (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"bank_account_type" forKey:@"bank_account_type"];
        [fieldMappings setObject:@"bank_address" forKey:@"bank_address"];
        [fieldMappings setObject:@"bank_country" forKey:@"bank_country"];
        [fieldMappings setObject:@"bic" forKey:@"bic"];
        [fieldMappings setObject:@"company_name" forKey:@"company_name"];
        [fieldMappings setObject:@"country" forKey:@"country"];
        [fieldMappings setObject:@"currency" forKey:@"currency"];
        [fieldMappings setObject:@"entity_type" forKey:@"entity_type"];
        [fieldMappings setObject:@"iban" forKey:@"iban"];
        [fieldMappings setObject:@"routing_code" forKey:@"routing_code"];
...
- (APEndPointConfiguration *)createConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.incrementalPath = @"/beneficiaries";
...
- (APEndPointConfiguration *)refreshConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.localToRemoteFieldPathsDictionary = fieldMappings;
        config.httpVerb = @"GET";
        config.incrementalPath = @"/beneficiaries/{{params.id}}";
