//
//  RetailBankingLogin+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingLogin+Remote.h"

@implementation RetailBankingLogin (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"token" forKey:@"token"];
        [fieldMappings setObject:@"is_eligible_for_offers" forKey:@"is_eligible_for_offers"];
        [fieldMappings setObject:@"is_person_to_person_required" forKey:@"is_person_to_person_required"];
        [fieldMappings setObject:@"password" forKey:@"password"];
        [fieldMappings setObject:@"username" forKey:@"username"];
