//
//  RetailBankingAccount+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingAccount+Remote
 @abstract Remote category for RetailBankingAccount class
 */

#import "RetailBankingAccount.h"

/*!
 @category RetailBankingAccount (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingAccount.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingAccount (Remote)
