//
//  RetailBankingRewardsCatalog+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingRewardsCatalog+Remote
 @abstract Remote category for RetailBankingRewardsCatalog class
 */

#import "RetailBankingRewardsCatalog.h"

/*!
 @category RetailBankingRewardsCatalog (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingRewardsCatalog.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingRewardsCatalog (Remote)
...
/*!
 @method rewardsCatalogWithItemCategory:error:
 @abstract Fetches objects matching query scope "rewards_catalog" from remote server.
...
/*!
 @method rewardsCatalogWithItemCategory:context:error:
 @abstract Fetches objects matching query scope "rewards_catalog" from remote server.
 @param itemCategory Scope parameter - itemCategory.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method rewardsCatalogWithItemCategory:offset:limit:error:
 @abstract Fetches objects matching query scope "rewards_catalog" from remote server, with pagination.
 @param itemCategory Scope parameter - itemCategory.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method rewardsCatalogWithItemCategory:offset:limit:context:error:
 @abstract Fetches objects matching query scope "rewards_catalog" from remote server, with pagination.
 @param itemCategory Scope parameter - itemCategory.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method rewardsCatalogWithItemCategory:async:
 @abstract Returns cached objects matching query scope "rewards_catalog", then fetches fresh ones from remote server.
 @param itemCategory Scope parameter - itemCategory.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method rewardsCatalogWithItemCategory:context:async:
 @abstract Returns cached objects matching query scope "rewards_catalog", then fetches fresh ones from remote server.
 @param itemCategory Scope parameter - itemCategory.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method rewardsCatalogWithItemCategory:offset:limit:async:
 @abstract Returns cached objects matching query scope "rewards_catalog", then fetches fresh ones from remote server, with pagination.
 @param itemCategory Scope parameter - itemCategory.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method rewardsCatalogWithItemCategory:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "rewards_catalog", then fetches fresh ones from remote server, with pagination.
 @param itemCategory Scope parameter - itemCategory.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
