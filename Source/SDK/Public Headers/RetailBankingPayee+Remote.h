//
//  RetailBankingPayee+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingPayee+Remote
 @abstract Remote category for RetailBankingPayee class
 */

#import "RetailBankingPayee.h"

/*!
 @category RetailBankingPayee (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingPayee.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingPayee (Remote)
