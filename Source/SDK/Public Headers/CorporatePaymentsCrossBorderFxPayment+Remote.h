//
//  CorporatePaymentsCrossBorderFxPayment+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsCrossBorderFxPayment+Remote
 @abstract Remote category for CorporatePaymentsCrossBorderFxPayment class
 */

#import "CorporatePaymentsCrossBorderFxPayment.h"

/*!
 @category CorporatePaymentsCrossBorderFxPayment (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsCrossBorderFxPayment.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsCrossBorderFxPayment (Remote)
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:error:
 @abstract Fetches objects matching query scope "fx_payments" from remote server.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:context:error:
 @abstract Fetches objects matching query scope "fx_payments" from remote server.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:offset:limit:error:
 @abstract Fetches objects matching query scope "fx_payments" from remote server, with pagination.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
 @param beneficiaryName Scope parameter - beneficiaryName.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:offset:limit:context:error:
 @abstract Fetches objects matching query scope "fx_payments" from remote server, with pagination.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:async:
 @abstract Returns cached objects matching query scope "fx_payments", then fetches fresh ones from remote server.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
 @param beneficiaryName Scope parameter - beneficiaryName.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:context:async:
 @abstract Returns cached objects matching query scope "fx_payments", then fetches fresh ones from remote server.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:offset:limit:async:
 @abstract Returns cached objects matching query scope "fx_payments", then fetches fresh ones from remote server, with pagination.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
 @param beneficiaryName Scope parameter - beneficiaryName.
...
/*!
 @method fxPaymentsWithCitiRef:customerTxnRef:toCurrency:beneficiaryName:valueDate:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "fx_payments", then fetches fresh ones from remote server, with pagination.
 @param citiRef Scope parameter - citiRef.
 @param customerTxnRef Scope parameter - customerTxnRef.
 @param toCurrency Scope parameter - toCurrency.
