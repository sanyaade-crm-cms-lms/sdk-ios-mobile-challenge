//
//  CorporatePaymentsBeneficiary+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsBeneficiary+Remote
 @abstract Remote category for CorporatePaymentsBeneficiary class
 */

#import "CorporatePaymentsBeneficiary.h"

/*!
 @category CorporatePaymentsBeneficiary (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsBeneficiary.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsBeneficiary (Remote)
