//
//  RetailBankingRewardsRedemption+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingRewardsRedemption+Remote
 @abstract Remote category for RetailBankingRewardsRedemption class
 */

#import "RetailBankingRewardsRedemption.h"

/*!
 @category RetailBankingRewardsRedemption (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingRewardsRedemption.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingRewardsRedemption (Remote)
