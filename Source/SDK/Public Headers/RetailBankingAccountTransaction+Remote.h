//
//  RetailBankingAccountTransaction+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingAccountTransaction+Remote
 @abstract Remote category for RetailBankingAccountTransaction class
 */

#import "RetailBankingAccountTransaction.h"

/*!
 @category RetailBankingAccountTransaction (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingAccountTransaction.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingAccountTransaction (Remote)
