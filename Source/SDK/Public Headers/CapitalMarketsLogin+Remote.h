//
//  CapitalMarketsLogin+Remote.h
//  AnyPresence SDK
//

/*!
 @header CapitalMarketsLogin+Remote
 @abstract Remote category for CapitalMarketsLogin class
 */

#import "CapitalMarketsLogin.h"

/*!
 @category CapitalMarketsLogin (Remote)
 @abstract Adds remote CRUD capabilities to CapitalMarketsLogin.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CapitalMarketsLogin (Remote)
