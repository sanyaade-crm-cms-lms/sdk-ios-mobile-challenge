//
//  CorporatePaymentsPayment+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "CorporatePaymentsPayment+Remote.h"

@implementation CorporatePaymentsPayment (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"beneficiary_id" forKey:@"beneficiary_id"];
        ...
        [fieldMappings setObject:@"customer_reference_number" forKey:@"customer_reference_number"];
        [fieldMappings setObject:@"debit_account_name" forKey:@"debit_account_name"];
        [fieldMappings setObject:@"debit_account_number" forKey:@"debit_account_number"];
        [fieldMappings setObject:@"email" forKey:@"email"];
        [fieldMappings setObject:@"payment_amount" forKey:@"payment_amount"];
        [fieldMappings setObject:@"payment_currency" forKey:@"payment_currency"];
        ...
        [fieldMappings setObject:@"payment_type" forKey:@"payment_type"];
        [fieldMappings setObject:@"status" forKey:@"status"];
        [fieldMappings setObject:@"transaction_reference_number" forKey:@"transaction_reference_number"];
        ...
        config.httpVerb = @"GET";
        config.incrementalPath = @"/payments";
...
- (APEndPointConfiguration *)refreshConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.localToRemoteFieldPathsDictionary = fieldMappings;
        config.httpVerb = @"GET";
        config.incrementalPath = @"/payments/{{params.id}}";
