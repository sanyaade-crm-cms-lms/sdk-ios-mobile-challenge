//
//  RetailBankingAccountTransaction+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingAccountTransaction+Remote.h"

@implementation RetailBankingAccountTransaction (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"account_id" forKey:@"account_id"];
        [fieldMappings setObject:@"activity" forKey:@"activity"];
        [fieldMappings setObject:@"check_image_eligible" forKey:@"check_image_eligible"];
        [fieldMappings setObject:@"date_posted" forKey:@"date_posted"];
        [fieldMappings setObject:@"formatted_amount" forKey:@"formatted_amount"];
        [fieldMappings setObject:@"pending_date" forKey:@"pending_date"];
        [fieldMappings setObject:@"transaction_amount" forKey:@"transaction_amount"];
        [fieldMappings setObject:@"description" forKey:@"transaction_description"];
        [fieldMappings setObject:@"transaction_identifier" forKey:@"transaction_identifier"];
        [fieldMappings setObject:@"transaction_index" forKey:@"transaction_index"];
        [fieldMappings setObject:@"transaction_type" forKey:@"transaction_type"];
        ...
        config.httpVerb = @"GET";
        config.incrementalPath = @"/accounts/{{params.id}}/transactions";
