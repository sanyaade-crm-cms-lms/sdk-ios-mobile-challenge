//
//  RetailBankingRewardsRedemption+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingRewardsRedemption+Remote.h"

@implementation RetailBankingRewardsRedemption (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"redemption_details" forKey:@"redemption_details"];
...
- (APEndPointConfiguration *)createConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.incrementalPath = @"/rewards/redemption";
