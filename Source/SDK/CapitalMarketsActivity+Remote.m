//
//  CapitalMarketsActivity+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "CapitalMarketsActivity+Remote.h"

@implementation CapitalMarketsActivity (Remote)
...
+ (NSArray *)activitiesWithYear:(NSNumber *)year error:(NSError **)error {
    ...
    return [self query:@"activities" params:params context:nil config:[self activitiesConfig] error:error];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year context:(id)context error:(NSError **)error {
    ...
    return [self query:@"activities" params:params context:context config:[self activitiesConfig] error:error];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"activities" params:params offset:offset limit:limit context:nil config:[self activitiesConfig] error:error];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"activities" params:params offset:offset limit:limit context:context config:[self activitiesConfig] error:error];
}
...
+ (NSArray *)activitiesWithYear:(NSNumber *)year async:(APObjectsCallback)callback {
    ...
    return [self query:@"activities" params:params context:nil config:[self activitiesConfig] async:callback];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"activities" params:params context:context config:[self activitiesConfig] async:callback];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"activities" params:params offset:offset limit:limit context:nil config:[self activitiesConfig] async:callback];
}

+ (NSArray *)activitiesWithYear:(NSNumber *)year offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"activities" params:params offset:offset limit:limit context:context config:[self activitiesConfig] async:callback];
}
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"activity_type" forKey:@"activity_type"];
        [fieldMappings setObject:@"citi_attendees" forKey:@"citi_attendees"];
        [fieldMappings setObject:@"client_contacts" forKey:@"client_contacts"];
        [fieldMappings setObject:@"client_id" forKey:@"client_id"];
        [fieldMappings setObject:@"client_name" forKey:@"client_name"];
        [fieldMappings setObject:@"date" forKey:@"date"];
...
+ (APEndPointConfiguration *)activitiesConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.localToRemoteFieldPathsDictionary = fieldMappings;
        config.httpVerb = @"GET";
        config.incrementalPath = @"/activities";
