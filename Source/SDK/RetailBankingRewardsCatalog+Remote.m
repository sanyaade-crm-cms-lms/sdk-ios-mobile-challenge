//
//  RetailBankingRewardsCatalog+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingRewardsCatalog+Remote.h"

@implementation RetailBankingRewardsCatalog (Remote)
...
+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory error:(NSError **)error {
    
    NSMutableDictionary * params = [[NSMutableDictionary alloc] initWithCapacity:1];
    
    if (itemCategory) {
        NSString *key = @"item_category";
        key = @"item_category";

        [params setObject:itemCategory forKey:key];
    }

    return [self query:@"rewards_catalog" params:params context:nil config:[self rewardsCatalogConfig] error:error];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory context:(id)context error:(NSError **)error {
    ...
    return [self query:@"rewards_catalog" params:params context:context config:[self rewardsCatalogConfig] error:error];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"rewards_catalog" params:params offset:offset limit:limit context:nil config:[self rewardsCatalogConfig] error:error];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"rewards_catalog" params:params offset:offset limit:limit context:context config:[self rewardsCatalogConfig] error:error];
}
...
+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory async:(APObjectsCallback)callback {
    ...
    return [self query:@"rewards_catalog" params:params context:nil config:[self rewardsCatalogConfig] async:callback];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"rewards_catalog" params:params context:context config:[self rewardsCatalogConfig] async:callback];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"rewards_catalog" params:params offset:offset limit:limit context:nil config:[self rewardsCatalogConfig] async:callback];
}

+ (NSArray *)rewardsCatalogWithItemCategory:(NSString *)itemCategory offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"rewards_catalog" params:params offset:offset limit:limit context:context config:[self rewardsCatalogConfig] async:callback];
}
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"item_category" forKey:@"item_category"];
        [fieldMappings setObject:@"item_code" forKey:@"item_code"];
        [fieldMappings setObject:@"item_description" forKey:@"item_description"];
        [fieldMappings setObject:@"item_name" forKey:@"item_name"];
        [fieldMappings setObject:@"point_required" forKey:@"point_required"];
        [fieldMappings setObject:@"points_available" forKey:@"points_available"];
...
+ (APEndPointConfiguration *)rewardsCatalogConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"item_code" forKey:@"item_code"];
        [fieldMappings setObject:@"item_category" forKey:@"item_category"];
        [fieldMappings setObject:@"item_code" forKey:@"id"];
    
        config.localToRemoteFieldPathsDictionary = fieldMappings;
        config.httpVerb = @"GET";
        config.incrementalPath = @"/rewards/catalog";

        NSMutableDictionary *incrementalHttpHeaders = [NSMutableDictionary new];
        config.incrementalHttpHeaders = incrementalHttpHeaders;

        NSMutableDictionary *incrementalURLParameters = [NSMutableDictionary new];
        [incrementalURLParameters setObject:@"{{query.query.item_category}}" forKey:@"item_category"];
        config.incrementalURLParameters = incrementalURLParameters;
