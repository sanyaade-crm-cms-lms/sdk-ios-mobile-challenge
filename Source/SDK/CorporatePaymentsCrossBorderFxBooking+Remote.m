//
//  CorporatePaymentsCrossBorderFxBooking+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "CorporatePaymentsCrossBorderFxBooking+Remote.h"

@implementation CorporatePaymentsCrossBorderFxBooking (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"accepted_on" forKey:@"accepted_on"];
        [fieldMappings setObject:@"accepted_by" forKey:@"accepted_by"];
...
- (APEndPointConfiguration *)createConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.incrementalPath = @"/crossborder/fx_bookings";
