//
//  RetailBankingAccountFundTransfer+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "RetailBankingAccountFundTransfer+Remote.h"

@implementation RetailBankingAccountFundTransfer (Remote)
...
+ (APEndPointConfiguration *)allConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [fieldMappings setObject:@"amount" forKey:@"amount"];
        [fieldMappings setObject:@"currency" forKey:@"currency"];
        [fieldMappings setObject:@"destination_account_id" forKey:@"destination_account_id"];
        [fieldMappings setObject:@"destination_id" forKey:@"destination_id"];
        [fieldMappings setObject:@"memo" forKey:@"memo"];
        [fieldMappings setObject:@"payee_desc" forKey:@"payee_desc"];
        [fieldMappings setObject:@"payee_id" forKey:@"payee_id"];
        [fieldMappings setObject:@"payee_type" forKey:@"payee_type"];
        [fieldMappings setObject:@"payment_type" forKey:@"payment_type"];
        [fieldMappings setObject:@"reference_number" forKey:@"reference_number"];
        [fieldMappings setObject:@"transaction_date" forKey:@"transaction_date"];
...
- (APEndPointConfiguration *)createConfig {
    ...
    dispatch_once(&onceToken, ^{
        ...
        config.incrementalPath = @"/accounts/{{params.id}}/fund_transfers";
