//
//  CorporatePaymentsPayment+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsPayment+Remote
 @abstract Remote category for CorporatePaymentsPayment class
 */

#import "CorporatePaymentsPayment.h"

/*!
 @category CorporatePaymentsPayment (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsPayment.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsPayment (Remote)
