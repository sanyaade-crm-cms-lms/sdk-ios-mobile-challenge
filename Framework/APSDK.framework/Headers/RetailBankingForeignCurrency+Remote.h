//
//  RetailBankingForeignCurrency+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingForeignCurrency+Remote
 @abstract Remote category for RetailBankingForeignCurrency class
 */

#import "RetailBankingForeignCurrency.h"

/*!
 @category RetailBankingForeignCurrency (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingForeignCurrency.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingForeignCurrency (Remote)
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:error:
 @abstract Fetches objects matching query scope "foreign_currency" from remote server.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:context:error:
 @abstract Fetches objects matching query scope "foreign_currency" from remote server.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:offset:limit:error:
 @abstract Fetches objects matching query scope "foreign_currency" from remote server, with pagination.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:offset:limit:context:error:
 @abstract Fetches objects matching query scope "foreign_currency" from remote server, with pagination.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param offset Number of objects to skip.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:async:
 @abstract Returns cached objects matching query scope "foreign_currency", then fetches fresh ones from remote server.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:context:async:
 @abstract Returns cached objects matching query scope "foreign_currency", then fetches fresh ones from remote server.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:offset:limit:async:
 @abstract Returns cached objects matching query scope "foreign_currency", then fetches fresh ones from remote server, with pagination.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method foreignCurrencyWithFromCurrency:toCurrency:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "foreign_currency", then fetches fresh ones from remote server, with pagination.
 @param fromCurrency Scope parameter - fromCurrency.
 @param toCurrency Scope parameter - toCurrency.
 @param offset Number of objects to skip.
