//
//  RetailBankingAccountBalance+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingAccountBalance+Remote
 @abstract Remote category for RetailBankingAccountBalance class
 */

#import "RetailBankingAccountBalance.h"

/*!
 @category RetailBankingAccountBalance (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingAccountBalance.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingAccountBalance (Remote)
