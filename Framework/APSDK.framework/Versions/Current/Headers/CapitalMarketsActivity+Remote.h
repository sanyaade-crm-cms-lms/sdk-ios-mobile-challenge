//
//  CapitalMarketsActivity+Remote.h
//  AnyPresence SDK
//

/*!
 @header CapitalMarketsActivity+Remote
 @abstract Remote category for CapitalMarketsActivity class
 */

#import "CapitalMarketsActivity.h"

/*!
 @category CapitalMarketsActivity (Remote)
 @abstract Adds remote CRUD capabilities to CapitalMarketsActivity.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CapitalMarketsActivity (Remote)
...
/*!
 @method activitiesWithYear:error:
 @abstract Fetches objects matching query scope "activities" from remote server.
...
/*!
 @method activitiesWithYear:context:error:
 @abstract Fetches objects matching query scope "activities" from remote server.
 @param year Scope parameter - year.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method activitiesWithYear:offset:limit:error:
 @abstract Fetches objects matching query scope "activities" from remote server, with pagination.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method activitiesWithYear:offset:limit:context:error:
 @abstract Fetches objects matching query scope "activities" from remote server, with pagination.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method activitiesWithYear:async:
 @abstract Returns cached objects matching query scope "activities", then fetches fresh ones from remote server.
 @param year Scope parameter - year.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method activitiesWithYear:context:async:
 @abstract Returns cached objects matching query scope "activities", then fetches fresh ones from remote server.
 @param year Scope parameter - year.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method activitiesWithYear:offset:limit:async:
 @abstract Returns cached objects matching query scope "activities", then fetches fresh ones from remote server, with pagination.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method activitiesWithYear:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "activities", then fetches fresh ones from remote server, with pagination.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
