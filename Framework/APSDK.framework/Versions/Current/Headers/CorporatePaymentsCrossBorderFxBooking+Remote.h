//
//  CorporatePaymentsCrossBorderFxBooking+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsCrossBorderFxBooking+Remote
 @abstract Remote category for CorporatePaymentsCrossBorderFxBooking class
 */

#import "CorporatePaymentsCrossBorderFxBooking.h"

/*!
 @category CorporatePaymentsCrossBorderFxBooking (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsCrossBorderFxBooking.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsCrossBorderFxBooking (Remote)
