//
//  CapitalMarketsOrder+Remote.h
//  AnyPresence SDK
//

/*!
 @header CapitalMarketsOrder+Remote
 @abstract Remote category for CapitalMarketsOrder class
 */

#import "CapitalMarketsOrder.h"

/*!
 @category CapitalMarketsOrder (Remote)
 @abstract Adds remote CRUD capabilities to CapitalMarketsOrder.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CapitalMarketsOrder (Remote)
