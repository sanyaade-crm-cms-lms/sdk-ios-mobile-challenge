//
//  RetailBankingLogin+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingLogin+Remote
 @abstract Remote category for RetailBankingLogin class
 */

#import "RetailBankingLogin.h"

/*!
 @category RetailBankingLogin (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingLogin.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingLogin (Remote)
