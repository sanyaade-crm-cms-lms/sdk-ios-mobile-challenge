//
//  CapitalMarketsContentService+Remote.h
//  AnyPresence SDK
//

/*!
 @header CapitalMarketsContentService+Remote
 @abstract Remote category for CapitalMarketsContentService class
 */

#import "CapitalMarketsContentService.h"

/*!
 @category CapitalMarketsContentService (Remote)
 @abstract Adds remote CRUD capabilities to CapitalMarketsContentService.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CapitalMarketsContentService (Remote)
...
/*!
 @method contentServicesWithType:error:
 @abstract Fetches objects matching query scope "content_services" from remote server.
...
/*!
 @method contentServicesWithType:context:error:
 @abstract Fetches objects matching query scope "content_services" from remote server.
 @param type Scope parameter - type.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method contentServicesWithType:offset:limit:error:
 @abstract Fetches objects matching query scope "content_services" from remote server, with pagination.
 @param type Scope parameter - type.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method contentServicesWithType:offset:limit:context:error:
 @abstract Fetches objects matching query scope "content_services" from remote server, with pagination.
 @param type Scope parameter - type.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method contentServicesWithType:async:
 @abstract Returns cached objects matching query scope "content_services", then fetches fresh ones from remote server.
 @param type Scope parameter - type.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method contentServicesWithType:context:async:
 @abstract Returns cached objects matching query scope "content_services", then fetches fresh ones from remote server.
 @param type Scope parameter - type.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method contentServicesWithType:offset:limit:async:
 @abstract Returns cached objects matching query scope "content_services", then fetches fresh ones from remote server, with pagination.
 @param type Scope parameter - type.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method contentServicesWithType:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "content_services", then fetches fresh ones from remote server, with pagination.
 @param type Scope parameter - type.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
