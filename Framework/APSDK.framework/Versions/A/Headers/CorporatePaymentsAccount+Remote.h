//
//  CorporatePaymentsAccount+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsAccount+Remote
 @abstract Remote category for CorporatePaymentsAccount class
 */

#import "CorporatePaymentsAccount.h"

/*!
 @category CorporatePaymentsAccount (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsAccount.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsAccount (Remote)
