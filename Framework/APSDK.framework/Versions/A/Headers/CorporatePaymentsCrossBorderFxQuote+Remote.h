//
//  CorporatePaymentsCrossBorderFxQuote+Remote.h
//  AnyPresence SDK
//

/*!
 @header CorporatePaymentsCrossBorderFxQuote+Remote
 @abstract Remote category for CorporatePaymentsCrossBorderFxQuote class
 */

#import "CorporatePaymentsCrossBorderFxQuote.h"

/*!
 @category CorporatePaymentsCrossBorderFxQuote (Remote)
 @abstract Adds remote CRUD capabilities to CorporatePaymentsCrossBorderFxQuote.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CorporatePaymentsCrossBorderFxQuote (Remote)
