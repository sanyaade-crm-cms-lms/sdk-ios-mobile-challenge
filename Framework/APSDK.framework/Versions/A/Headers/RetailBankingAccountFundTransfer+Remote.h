//
//  RetailBankingAccountFundTransfer+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingAccountFundTransfer+Remote
 @abstract Remote category for RetailBankingAccountFundTransfer class
 */

#import "RetailBankingAccountFundTransfer.h"

/*!
 @category RetailBankingAccountFundTransfer (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingAccountFundTransfer.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingAccountFundTransfer (Remote)
