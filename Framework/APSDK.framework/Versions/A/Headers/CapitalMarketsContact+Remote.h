//
//  CapitalMarketsContact+Remote.h
//  AnyPresence SDK
//

/*!
 @header CapitalMarketsContact+Remote
 @abstract Remote category for CapitalMarketsContact class
 */

#import "CapitalMarketsContact.h"

/*!
 @category CapitalMarketsContact (Remote)
 @abstract Adds remote CRUD capabilities to CapitalMarketsContact.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface CapitalMarketsContact (Remote)
...
/*!
 @method contactsWithClientName:year:error:
 @abstract Fetches objects matching query scope "contacts" from remote server.
...
/*!
 @method contactsWithClientName:year:context:error:
 @abstract Fetches objects matching query scope "contacts" from remote server.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method contactsWithClientName:year:offset:limit:error:
 @abstract Fetches objects matching query scope "contacts" from remote server, with pagination.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method contactsWithClientName:year:offset:limit:context:error:
 @abstract Fetches objects matching query scope "contacts" from remote server, with pagination.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
...
/*!
 @method contactsWithClientName:year:async:
 @abstract Returns cached objects matching query scope "contacts", then fetches fresh ones from remote server.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
...
/*!
 @method contactsWithClientName:year:context:async:
 @abstract Returns cached objects matching query scope "contacts", then fetches fresh ones from remote server.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method contactsWithClientName:year:offset:limit:async:
 @abstract Returns cached objects matching query scope "contacts", then fetches fresh ones from remote server, with pagination.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method contactsWithClientName:year:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "contacts", then fetches fresh ones from remote server, with pagination.
 @param clientName Scope parameter - clientName.
 @param year Scope parameter - year.
 @param offset Number of objects to skip.
