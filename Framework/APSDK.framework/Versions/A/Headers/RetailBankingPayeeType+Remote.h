//
//  RetailBankingPayeeType+Remote.h
//  AnyPresence SDK
//

/*!
 @header RetailBankingPayeeType+Remote
 @abstract Remote category for RetailBankingPayeeType class
 */

#import "RetailBankingPayeeType.h"

/*!
 @category RetailBankingPayeeType (Remote)
 @abstract Adds remote CRUD capabilities to RetailBankingPayeeType.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface RetailBankingPayeeType (Remote)
